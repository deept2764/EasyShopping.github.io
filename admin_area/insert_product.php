...
<body>
	<div class="row"><!-- breadcumb row Start-->
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" method="post" action="" enctype="multipart-form-data">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Product Descripition</label>
...
if(isset($_POST['submit'])) {
  ...
  if ($run_product) {
  	...
  	echo "<script>window.open('inset_product.php')</script>";
  	  }
