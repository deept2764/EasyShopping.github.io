      	...
      	<div class="row">
      		...
      		<div class="col-sm-4 col-sm-6 single"> <!--col-sm-4 col-sm-6 single Start-->
      			<div class="product">
      				...
      				<div class="text">
      					<h3><a href="details.php">Allen Solly</a></h3>
      		...
      		<div class="col-sm-4 col-sm-6 single"> <!--col-sm-4 col-sm-6 single Start-->
      			<div class="product">
      				<a href="details.php">
      					<img src="admin_area/product_images/top1.png" class="img-responsive">
      				</a>
      				<div class="text">
      					<h3><a href="details.php">Allen Solly</a></h3>
      				<p class="price"> INR 499</p>
      		...
      		<div class="col-sm-4 col-sm-6 single"> <!--col-sm-4 col-sm-6 single Start-->
      			<div class="product">
      				<a href="details.php">
      					<img src="admin_area/product_images/top2.png" class="img-responsive">
      				</a>
      				<div class="text">
      					<h3><a href="details.php">Allen Solly</a></h3>
      				<p class="price"> INR 499</p>
